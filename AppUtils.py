...
def MasonryBox(adapt=((999, 2, Adw.BreakpointConditionLengthType.MAX_WIDTH), (1200, 4, Adw.BreakpointConditionLengthType.MIN_WIDTH), (1000, 3, Adw.BreakpointConditionLengthType.MIN_WIDTH)), activate=None) -> Adw.BreakpointBin:
